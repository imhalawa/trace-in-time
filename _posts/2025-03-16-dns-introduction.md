...
{% include figure.liquid loading="eager" path="assets/img/series/dns/dns-introduction-figure1.svg" class="img-fluid rounded" %}
...
{% include figure.liquid loading="eager" path="assets/img/series/dns/dns-introduction-figure2.png" class="img-fluid rounded" %}
...
{% include figure.liquid loading="eager" path="assets/img/series/dns/dns-introduction-figure3.svg" class="img-fluid rounded" %}
...
{% include figure.liquid loading="eager" path="assets/img/series/dns/dns-introduction-figure4.png" class="img-fluid rounded" %}
