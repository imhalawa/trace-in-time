---
layout: post
title: "6. Async Exceptions in C#: How to Catch Them Correctly"
series: async-await
part: 6
description: "In async code, exceptions travel through the Task and surface at the await point. Learn where to catch them and why async void makes exceptions disappear."
date: 2025-10-25
tags: [dotnet, async-await, series]
tags_color: "#4122aa"
permalink: /series/async-await/async-exceptions-csharp/
---
## When Something Burns

In the [previous part](/series/async-await/continuation-and-context/), we explored how asynchronous methods pick up exactly where they left off. In code, that's an exception—and in asynchronous code, knowing where it surfaces is half the battle.
